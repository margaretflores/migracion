<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="registrocompras.aspx.cs" Inherits="appFew.reportes.registrocompras" %>
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1" 
                        Font-Names="Verdana" Text="PDB Registro de Compras"></asp:Label>
