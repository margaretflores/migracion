<%@ Page Title="Tabla de Estándares por Calidad" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="estandarescalidades.aspx.cs" Inherits="appFew.estd.estandarescalidades" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div >
        ...
        <table style="width: 750px;" >
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1ddl" Font-Names="Verdana" Text="Tabla de Estándares por Calidad"></asp:Label></td>
        ...
        <table>
            ...
            <tr>
                <td style="text-align:left; width:20%; " valign="middle">
                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small" Text="Variable:" ></asp:Label>
                </td>
                <td colspan="1" align="left">
...
<%--            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>--%>
                    <asp:GridView ID="cabeceraGridView" Width="100%" runat="server" DataKeyNames="TESTIDTE"  
                        ...
                        <Columns>
                            <asp:BoundField DataField="TESTIDTE" HeaderText="ID" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"  >
                                <HeaderStyle CssClass="hideGridColumn" />
                                <ItemStyle CssClass="hideGridColumn" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TESTIDVA" HeaderText="IDVAR" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"  >
                                <HeaderStyle CssClass="hideGridColumn" />
                                <ItemStyle CssClass="hideGridColumn" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="Calidad" HeaderStyle-CssClass="hs" ItemStyle-CssClass="is">
                                            <ItemTemplate>
                                                <%#Eval("TESTCALI") %> <%#Eval("DECADESC")%>
                                            </ItemTemplate>
                            ...
                            <asp:BoundField DataField="TESTCOLP" HeaderText="IDLN" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"  >
                                <HeaderStyle CssClass="hideGridColumn" />
                                <ItemStyle CssClass="hideGridColumn" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="TESTCOTP" HeaderText="IDPR" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"  >
                                <HeaderStyle CssClass="hideGridColumn" />
                                <ItemStyle CssClass="hideGridColumn" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="TCTEDECO" HeaderText="Tipo Valor" HeaderStyle-CssClass="hsleft" ItemStyle-CssClass="is"  >
                                <HeaderStyle CssClass="hsleft" />
                                <ItemStyle CssClass="is" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TESTVAL1" HeaderText="Valor 1" HeaderStyle-CssClass="hsright" ItemStyle-CssClass="is" >
                                <HeaderStyle CssClass="hsright" />
                                <ItemStyle CssClass="is" HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TESTVAL2" HeaderText="Valor 2" HeaderStyle-CssClass="hsright" ItemStyle-CssClass="is" >
                                <HeaderStyle CssClass="hsright" />
                                <ItemStyle CssClass="is" HorizontalAlign="Right" />
                            </asp:BoundField>
            ...
            <tr class="fs">
                ...
                <td style="width:14%; padding:5px; text-align: left" >Tipo Valor:</td>
                ...
                <td colspan="4">
                      <div>
                        <table width="100%" style="padding:1px" class="iscb" >
                            <tr>
                                <td width="14%">Calidad</td>
                                <td>:</td>
                                <td width="30%"><b><asp:Label ID="calidadLabel" runat="server" ></asp:Label></b></td>
                            ...
                            <tr>
                                <td>Valor 1</td>
                                <td>:</td>
                                <td><b><asp:Label ID="valor1Label" runat="server" ></asp:Label></b></td>
                                <td style="padding:2px"></td>
                                <td></td>
                                <td></td>
                                <td</td>
                            ...
                            <tr>
                                <td>Valor 2</td>
                                <td>:</td>
                                <td><b><asp:Label ID="valor2Label" runat="server" ></asp:Label></b></td>
                                <td style="padding:2px"></td>
                                <td></td>
                                <td></td>
                                <td></td>
    ...
    <asp:Panel ID="panelEdit" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="510" Height="260">  
        ...
        <asp:Literal ID="tituloeditLiteral" runat="server" Text="Modificar Estándar"></asp:Literal></b></asp:Panel>
                ...
                <td >
                    <asp:DropDownList ID="linproDropDownList" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="linproDropDownList_SelectedIndexChanged">
                            <asp:ListItem Value="0" Text="[Todas las Líneas]"></asp:ListItem>
                    </asp:DropDownList>
                </td>  
            </tr>
            <tr style="background-color:#F3F3F3; ">
                ...
                <td >
                    <asp:DropDownList ID="tipproDropDownList" runat="server" AutoPostBack="False">
                            <asp:ListItem Value="0" Text="[Todos los Procesos]"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label10" runat="server" >Calidad:</asp:Label></td>
                <td >
                    <asp:DropDownList ID="calidDropDownList" runat="server" AutoPostBack="False">
                            <asp:ListItem Value="0" Text="[Seleccione la Calidad]"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="calidRequiredFieldValidator" runat="server" ControlToValidate="calidDropDownList" Display="None" ErrorMessage="Seleccione la Calidad" InitialValue="0" ValidationGroup="edit"></asp:RequiredFieldValidator>
                    <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server" TargetControlID="calidRequiredFieldValidator" ></cc1:ValidatorCalloutExtender>
                </td>
            </tr>
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                ...
                <td >
                    <asp:DropDownList ID="varnomDropDownList" runat="server" AutoPostBack="False">
                            <asp:ListItem Value="0" Text="[Seleccione la Variable]"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="varcodRequiredFieldValidator" runat="server" ControlToValidate="varnomDropDownList" Display="None" ErrorMessage="Seleccione la Variable" InitialValue="0" ValidationGroup="edit"></asp:RequiredFieldValidator>
                    <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="varcodRequiredFieldValidator" ></cc1:ValidatorCalloutExtender>
                </td>
            </tr>
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label6" runat="server" >Tipo Valor:</asp:Label></td>
                <td >
                    ...
                    <asp:RequiredFieldValidator ID="metcalRequiredFieldValidator" runat="server" ControlToValidate="tipvaleditDropDownList" Display="None" ErrorMessage="Seleccione tipo valor" InitialValue="0" ValidationGroup="edit"></asp:RequiredFieldValidator>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label3" runat="server" >Rango inicial/Valor fijo:</asp:Label></td>
                <td >
                    <asp:TextBox ID="valor1editTextBox" runat="server" Font-Size="Small" MaxLength="10"  style="width:48%; text-align:right; " ></asp:TextBox> 
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="Numbers, Custom" ValidChars="." TargetControlID="valor1editTextBox" />
                    <asp:RequiredFieldValidator ID="canmueRequiredFieldValidator" runat="server" ControlToValidate="valor1editTextBox" Display="None" ErrorMessage="Ingrese el rango inicial o el valor fijo"  ValidationGroup="edit" ></asp:RequiredFieldValidator>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label5" runat="server" >Rango final/% tolerancia:</asp:Label></td>
                <td >
                    <asp:TextBox ID="valor2editTextBox" runat="server" Font-Size="Small" MaxLength="10" style="width:48%; text-align:right; " ></asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers, Custom" ValidChars="." TargetControlID="valor2editTextBox" />
                </td>  
            </tr>
