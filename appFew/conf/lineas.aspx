<%@ Page Title="Líneas de Producción" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="lineas.aspx.cs" Inherits="appFew.conf.lineas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
           ...
           <tr style="background-color:#F3F3F3; ">
            ...
            <tr style="background-color:#E3E3E3">
                <td style="text-align:left " valign="middle">
                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small" Text="Línea de Producción:" ></asp:Label>
                </td>
                <td colspan="3">
  ...
  <!--Panel to Show Lot Search-->         
    ...
    <asp:Panel ID="contentBusqpanel" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="450" Height="450">  
        <asp:Panel ID="tituloBusqpanel" runat="server" style="cursor:move;font-family:Tahoma;padding:2px;" HorizontalAlign="Center" BackColor="#383F52" ForeColor="White" Height="25" ><b>Líneas de Producción</b></asp:Panel>
            ...
            <tr>
                ...
                <div style="height:100%; overflow:auto;">
                    <asp:GridView ID="busqLoteGridView" Width="100%" HorizontalAlign="Center" DataKeyNames="LIPRCODI"  
                        ...
                        <Columns> 
                            <asp:BoundField DataField="LIPRCODI" HeaderText="Código"  ItemStyle-CssClass="is" FooterStyle-CssClass="fs" ItemStyle-HorizontalAlign="Right"  />
                            <asp:BoundField DataField="LIPRDESC" HeaderText="Línea Producción"  ItemStyle-CssClass="is" FooterStyle-CssClass="fs"   />
                            <asp:BoundField DataField="CLIPESTA" HeaderText="Habilitado" ItemStyle-CssClass="is" FooterStyle-CssClass="fs"   />
                            <asp:BoundField DataField="CLIPESTA" HeaderText="Estado" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" FooterStyle-CssClass="hideGridColumn"  >
