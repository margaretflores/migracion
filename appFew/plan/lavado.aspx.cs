...
{
    public partial class lavado : System.Web.UI.Page
    {
        ...
        private void ObtenerExistencias()
        {
            ...
            try
            {
                ...
                parametros.Add(Convert.ToString( Constantes.CODIGO_LINEA_LAVADO_ZAM));
                ...
                if (resultado.ESTOPE)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlc/Lavado.rdlc");
