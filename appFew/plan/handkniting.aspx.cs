...
{
    public partial class handkniting : System.Web.UI.Page
    {
        ...
        private void ObtenerExistencias()
        {
            ...
            try
            {
                ...
                parametros.Add(Convert.ToString( Constantes.CODIGO_LINEA_ACABADO_HK));
                ...
                if (resultado.ESTOPE)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlc/Handkniting.rdlc");
