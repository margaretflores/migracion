<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="detcontrato.aspx.cs" Inherits="appFew.reportes.detcontrato" %>
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1" 
                        Font-Names="Verdana" Text="Detalle Contrato"></asp:Label>
        ...
        <tbody>                        
            <tr >
                <td style="width:100px;">
                    <asp:Label ID="almacenLabel" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small">Contrato:</asp:Label></td>
                <td >
                    <asp:TextBox ID="contratoTextBox" runat="server" MaxLength="5"></asp:TextBox>          
                    <asp:RequiredFieldValidator  ID="RequiredFieldValidatorContrato"  runat="server" ValidationGroup="GuardarGroup" ControlToValidate="contratoTextBox" ErrorMessage='Ingrese el número de contrato' EnableClientScript="true" SetFocusOnError="true" Text="*" >  
