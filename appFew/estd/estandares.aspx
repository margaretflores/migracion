<%@ Page Title="Tabla de Estándares" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="estandares.aspx.cs" Inherits="appFew.estd.estandares" %>
        ...
        <table style="width: 750px;" >
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1ddl" Font-Names="Verdana" Text="Tabla de Estándares"></asp:Label></td>
...
<%--            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>--%>
                    <asp:GridView ID="cabeceraGridView" Width="100%" runat="server" DataKeyNames="TESTIDTE"  
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TESTTPFI" HeaderText="Tipo Fibra" HeaderStyle-CssClass="hs" ItemStyle-CssClass="is" >
    ...
    <asp:Panel ID="panelEdit" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="510" Height="250">  
        ...
        <asp:Literal ID="tituloeditLiteral" runat="server" Text="Modificar Estándar"></asp:Literal></b></asp:Panel>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label9" runat="server" >Tipo Fibra:</asp:Label></td>
                <td >
                    <asp:DropDownList ID="tipfibDropDownList" runat="server" AutoPostBack="False">
                            ...
                            <asp:ListItem Value="ALP" Text="Alpaca"></asp:ListItem>
                            <asp:ListItem Value="OVJ" Text="Oveja"></asp:ListItem>
                            <asp:ListItem Value="LLA" Text="Llama"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr style="background-color:#F3F3F3; ">
