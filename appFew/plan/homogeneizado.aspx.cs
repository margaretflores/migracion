...
{
    public partial class homogeneizado : System.Web.UI.Page
    {
        ...
        private void ObtenerExistencias()
        {
            ...
            try
            {
                ...
                parametros.Add(Convert.ToString( Constantes.CODIGO_LINEA_HOMOGENEIZADO));
                ...
                if (resultado.ESTOPE)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlc/Homogeneizado.rdlc");
