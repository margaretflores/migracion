<%@ Page Title="Autorización de Solicitud Producto No Conforme" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="autorizacionprnc.aspx.cs" Inherits="appFew.ncon.autorizacionprnc" %>
        ...
        <table style="width: 750px;" >
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1ddl" Font-Names="Verdana" Text="Autorización de Solicitud Producto No Conforme"></asp:Label></td>
            ...
            <tr>
                <td class="toolbar" colspan="4" >
                     <table id="PosTable" runat="server" style="width: auto; font-size: 11px; font-family: Verdana;" cellpadding="5" cellspacing="0">
                        ...
                        <td style="padding-left: 5px; " align="left">
                            <asp:Button ID="verButton" runat="server" CommandName="Save" Text="Ver" 
                                    ValidationGroup="BuscarGroup" Enabled="False" style="width:72px;" onclick="verButton_Click" 
                                 />
                        </td>
                        <td class="toolbarsep" >
                        </td>
                        <td style="padding-left: 5px; " align="left">
                            <asp:Button ID="autorizarButton" runat="server" CommandName="Save" Text="Autorizar" 
                                    ValidationGroup="BuscarGroup" Enabled="False" style="width:72px;" onclick="autorizarButton_Click" 
                                 />
                        </td>                            
        ...
        <table>
            <tr>
                ...
                <td colspan="1" align="left">
                    <asp:DropDownList ID="linprofilDropDownList" runat="server" AutoPostBack="False" 
            ...
            <asp:Panel ID="contentfues2Panel" runat="server" style="display:none; background-color:#F3F3F3;" ForeColor="Black" Width="730" Height="420">  
                <asp:Panel ID="busqfueraestandar2Panel" runat="server" style="cursor:move;font-family:Tahoma;padding:2px;" HorizontalAlign="Center" BackColor="#383F52" ForeColor="White" Height="25" ><b>Generar Solicitud Autorización Producto No Conforme - Paso 2</b></asp:Panel>
                    ...
                    <tr>
                        <td colspan="4">
                                <div>
                                <table width="100%" style="padding:3px" class="iscb" >
                                    <tr>
                                        <td width="14%">Resultado:</td>
                                        <td></td>
                                        <td width="30%"><b><asp:Label ID="resultadoautLabel" runat="server" ></asp:Label></b></td>
                                        <td style="padding:2px"></td>
                                        <td width="14%">Estandar:</td>
                                        <td></td>
                                        <td width="30%"><b><asp:Label ID="estandarautLabel" runat="server" ></asp:Label></b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Ensayo: 
                ...
                <div align="right">
                    <asp:Button ID="aceptarfues2Button" runat="server" Width="70" Text="Autorizar" ValidationGroup="fueraestandar2Aceptar" onclick="aceptarfues2Button_Click"/>
                    &nbsp;
