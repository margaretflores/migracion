...
namespace appFew.conf
{
    public partial class procesos : System.Web.UI.Page
    {
        ...
        private List<PRTTPR> DetalleBusquedaLote { get; set; }
        ...
        private void SetDataSourceDetalleBusquedaLote(List<PRTTPR> _detalleDescarga)
        {
        ...
        private void LimpiaDatos()
        {
            ...
            tipproDropDownList.SelectedValue = "0";
        }
        ...
        private bool Guardar()
        {
            ...
            try
            {
                ...
                argumentos.CODOPE = CodigoOperacion.ACTUALIZA_TIPOS_PROCESO;
                //asigna parametros entrada en orden
                List<string> parEnt = new List<string>();
                registro = new PRTTPR() { TTPRCODI = decimal.Parse(tipproDropDownList.SelectedValue), CTTPESTA = habilCheckBox.Checked ? Constantes.ESTADO_ACTIVO : Constantes.ESTADO_ELIMINADO_NO_ACTIVO };
                parEnt.Add(FuncionesUtil.Serialize<PRTTPR>(registro));
        ...
        private bool BuscaRegistro()
        {
            ...
            try
            {
                ...
                //codigo de operacion
                PAROPE argumentos = new PAROPE();
                argumentos.CODOPE = CodigoOperacion.BUSCA_TIPOS_PROCESO;
                //asigna parametros entrada en orden
                List<string> parEnt = new List<string>();
                parEnt.Add(linproDropDownList.SelectedValue);
                ...
                if (resultado.ESTOPE)
                {
                    ...
                    {
                        DetalleBusquedaLote = FuncionesUtil.Deserialize<List<PRTTPR>>(resultado.VALSAL[1]);
        ...
        private void VistaBusquedaRegistro()
        {
            if (BuscaRegistro())
            {
                ...
                {
                    PRTTPR item = DetalleBusquedaLote[0];
                    AsignaValores(item.TTPRCODI.ToString(), item.CTTPESTA);
                }
                else
                {
                    SetDataSourceDetalleBusquedaLote(DetalleBusquedaLote);
                    lindesLabel.Text = linproDropDownList.SelectedItem.Text;
