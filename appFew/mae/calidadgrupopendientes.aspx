<%@ Page Title="Calidades Grupo de Pendientes" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="calidadgrupopendientes.aspx.cs" Inherits="appFew.mae.calidadgrupopendientes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div >
        ...
        <table style="width: 500px;" >
            <tr>
                <td style="width: auto; height: 24px;" colspan="4">
                    <asp:HiddenField ID="tablastiposHiddenField" runat="server" Value="TABL" />
                    <asp:DropDownList ID="tablastiposDropDownList" CssClass="titulo1ddl" 
                        runat="server" AutoPostBack="True" 
                        onselectedindexchanged="tablastiposDropDownList_SelectedIndexChanged">
                            <asp:ListItem Value="0" Text="[Seleccione Tabla Grupo de Pendientes]"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="tablastiposRequiredFieldValidator" runat="server" ControlToValidate="tablastiposDropDownList" Display="None" ErrorMessage="Seleccione la Tabla de Grupo de Pendientes" InitialValue="0" ValidationGroup="BuscarGroup"></asp:RequiredFieldValidator>
                    <cc1:ValidatorCalloutExtender ID="tablastiposValidatorCalloutExtender" runat="server" TargetControlID="tablastiposRequiredFieldValidator" ></cc1:ValidatorCalloutExtender>
                </td>
            </tr>
        </table>
        ...
        <div class="GridContainer">
            ...
            <asp:Button ID="buscarButton" runat="server" ValidationGroup="BuscarGroup" 
...
<%--            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:Panel ID="panelEdit" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="480" Height="210">  
