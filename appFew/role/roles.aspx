<%@ Page Title="Maestro de Roles" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="roles.aspx.cs" Inherits="appFew.role.roles" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <table style="width: 850px;" >
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo2" Font-Names="Verdana" Text="Maestro de Roles"></asp:Label></td>
            ...
            <hr />
                    <asp:GridView ID="cabeceraGridView" Width="100%" runat="server" DataKeyNames="GRUSCOGR"  
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GRUSDEGR" HeaderText="Descripción" HeaderStyle-CssClass="hsleft" ItemStyle-CssClass="is"  >
                                <HeaderStyle CssClass="hsleft" />
                                <ItemStyle CssClass="is" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ROAPESTA" HeaderText="ROAPESTA" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"  >
                                <HeaderStyle CssClass="hideGridColumn" />
                                <ItemStyle CssClass="hideGridColumn" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ROAPESTA" HeaderText="Activo" HeaderStyle-CssClass="hs" ItemStyle-CssClass="is" >
                                <HeaderStyle CssClass="hsleft" />
                                <ItemStyle CssClass="is" />
                            </asp:BoundField>
    ...
    <asp:Panel ID="panelEdit" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="510" Height="170">  
        ...
        <asp:Literal ID="tituloeditLiteral" runat="server" Text="Modificar Rol"></asp:Literal></b></asp:Panel>
            <table width="99%" style="border: thin solid #6B696B; margin-top: 0.5%; margin-left: 0.5%; margin-right: 0.5%;" 
            cellspacing="1" cellpadding="1" >

            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label17" runat="server" >Código:</asp:Label></td>
                <td >
                    <asp:TextBox ID="codgrueditTextBox" runat="server" MaxLength="10"  style="width:100px;" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="descortaRequiredFieldValidator" runat="server" ControlToValidate="codgrueditTextBox" Display="None" ErrorMessage="Ingrese un código para el Rol"  ValidationGroup="edit" ></asp:RequiredFieldValidator>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label3" runat="server" >Descripción:</asp:Label></td>
                <td >
                    <asp:TextBox ID="desgrueditTextBox" runat="server" Font-Size="Small" MaxLength="30"  style="text-align:left; " ></asp:TextBox><asp:HiddenField ID="codgruHiddenField" runat="server" /><asp:HiddenField ID="codaplHiddenField" runat="server" />
                    <asp:RequiredFieldValidator ID="nomvarRequiredFieldValidator" runat="server" ControlToValidate="desgrueditTextBox" Display="None" ErrorMessage="Ingrese la descripción del Rol"  ValidationGroup="edit" ></asp:RequiredFieldValidator>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hsedit">
                    <asp:Label ID="Label2" runat="server" >Estado Activo:</asp:Label></td>
                <td >
