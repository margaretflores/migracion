<%@ Page Title="Liberar Variables Fuera de Estándar" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="fueraestandar.aspx.cs" Inherits="appFew.cali.fueraestandar" %>
        ...
        <table style="width: 750px;" >
            ...
            <tr>
                <td style="width: auto; height: 24px;" colspan="2">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="titulo1ddl" Font-Names="Verdana" Text="Liberar Variables Fuera de Estándar"></asp:Label></td>
                <td style="width: auto; height: 24px; " colspan="2" align="right" >
                    &nbsp;</td>
            </tr>
        </table>
        <table style="width: 760px" cellspacing="0">
                     ...
                     <table id="PosTable" runat="server" style="width: auto; font-size: 11px; font-family: Verdana;" cellpadding="5" cellspacing="0">
                        ...
                        <td style="padding-left: 5px; " align="left">
                            <asp:Button ID="modificarButton" runat="server" CommandName="Save" Text="Ver Detalle" 
                                    ValidationGroup="BuscarGroup" Enabled="False" style="width:72px;" onclick="modificarButton_Click"  UseSubmitBehavior="False"
                                 />
                        </td>
                        <td class="toolbarsep" >
                        </td>
            ...
            <tr>
                ...
                <td colspan="1" align="left">
                    <asp:DropDownList ID="estautDropDownList" runat="server" AutoPostBack="False" >
                            ...
                            <asp:ListItem Value="R" Text="No Liberadas (rechazadas)"></asp:ListItem>
                    </asp:DropDownList>
...
<%--            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:Panel ID="panelEdit" runat="server" style="display:none; background-color:#E3E3E3;" ForeColor="Black" Width="580" Height="420">  
        ...
        <asp:Literal ID="tituloeditLiteral" runat="server" Text="Liberar Variable"></asp:Literal></b></asp:Panel>
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hs" width="30%" >
                    <asp:Label ID="Label13" runat="server" >Estado:</asp:Label></td>
                <td class="hsb">
                    <asp:Label ID="esteditLabel" runat="server" ></asp:Label>
                </td>  
            </tr>
            <tr style="background-color:#F3F3F3; ">
                <td class="hs" width="30%" >
            ...
            <tr style="background-color:#F3F3F3; ">
                <td class="hs" colspan="2">
                    ...
                    <asp:TextBox ID="obseditTextBox" MaxLength="500" width="96%" style="margin-left:2%;" runat="server" TextMode="MultiLine" />
                </td>  
            </tr>
                ...
                <div align="right">
                <asp:Button ID="aceptarBusqButton" runat="server" Width="70" Text="Liberar" 
                        ValidationGroup="edit" onclick="liberarvarButton_Click"/>
                &nbsp;
                <asp:Button ID="rechazarlibvarButton" runat="server" Width="70" Text="Rechazar" 
                        ValidationGroup="edit" onclick="rechazarlibvarButton_Click"/>
                &nbsp;
